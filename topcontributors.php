...
if ($cacheddata != "") {
	...
	$sql = "select to_timestamp((date_part('epoch', (time))::integer / 675::integer)::integer * 675::integer) at time zone 'UTC' -'3 hours'::interval as stime from $psqlschema.stats_shareagg where server=$serverid group by server,time order by time desc limit 1";
